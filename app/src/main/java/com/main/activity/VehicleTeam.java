 ...
 * 演示覆盖物的用法
 */
public class VehicleTeam extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.vehicleteam_layout);
	...
	public void initOverlay() {
		...
		OverlayOptions ooC = new MarkerOptions().position(llC).icon(bdC).perspective(false).anchor(0.5f, 0.5f)
				.rotate(30).zIndex(7);
		...
		giflist.add(bdB);
		giflist.add(bdC);
		OverlayOptions ooD = new MarkerOptions().position(llD).icons(giflist).zIndex(0).period(10);
		...
		mBaiduMap.setOnMarkerDragListener(new OnMarkerDragListener() {
			...
			public void onMarkerDragEnd(Marker marker) {
				Toast.makeText(VehicleTeam.this,
